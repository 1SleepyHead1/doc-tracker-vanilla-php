            ...
            <div class="row g-2">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="tel" class="form-control form-control-md" id="contact-no" name="contact-no" value="<?= $action == 1 ? substr($details['contact_no'], 3) : '' ?>" placeholder="9XX XXX XXXX" required>
                    </div>
                </div>
                <div class="col-md-3">
