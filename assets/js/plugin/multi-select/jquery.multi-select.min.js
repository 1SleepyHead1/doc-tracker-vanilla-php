(function (d) {
	...
	d.extend(h.prototype, {
		...
		K: function () {
			...
			this.l
				.attr({ role: "button", "aria-haspopup": "true", tabindex: 0, "aria-label": this.u.eq(0).text() })
				.on("keydown.multiselect", function (b) {
					var c = b.which;
					13 === c || 32 === c ? (b.preventDefault(), a.l.click()) : 40 === c ? (b.preventDefault(), a.C(), (a.s || a.o).children().first().focus()) : 27 === c && a.m();
				})
		...
		H: function () {
			...
			this.h.children("optgroup,option").each(function (b, c) {
				"OPTION" === c.nodeName ? ((b = a.B(d(c), b)), a.o.append(b)) : a.O(d(c), b);
			});
		},
		F: function (a, b) {
			a = b.which;
			38 === a ? (b.preventDefault(), (b = b.currentTarget), (a = b.previousElementSibling) && "LEGEND" === a.nodeName && (a = null), a || (a = b.parentNode.previousElementSibling), a ? ("LABEL" === a.nodeName ? a.focus() : a.lastChild.focus()) : this.l.focus()) : 40 === a && (b.preventDefault(), (b = b.currentTarget), (a = b.nextElementSibling), a || (a = b.parentNode.nextElementSibling), a && ("LABEL" === a.nodeName ? a.focus() : a.querySelector("label").focus()));
		},
		R: function () {
			var a = this;
			this.s = d(this.g.presetsHTML);
			this.i.prepend(this.s);
		...
		O: function (a, b) {
			var c = this,
				f = d(c.g.menuFieldsetHTML),
				e = a.attr("label");
			f.attr("data-label", e);
			e = d(c.g.menuFieldsetLegendHTML).text(e);
			f.append(e);
			a.children("option").each(function (g, l) {
				g = c.B(d(l), b + "_" + g);
				f.append(g);
			});
			c.o.append(f);
		...
		D: function () {
			this.j.hasClass(this.g.activeClass) ? this.m() : this.C();
		},
		v: function (a) {
			a.relatedTarget && !d(a.relatedTarget).closest(this.j).length && this.m();
		}
	});
	d.fn.multiSelect = function (a) {
		return this.each(function () {
			d.data(this, "plugin_multiSelect") || d.data(this, "plugin_multiSelect", new h(this, a));
		});
	};
})(jQuery);
