...
!(function (t) {
	...
	function i(t) {
		var e = qt.defaults.oLanguage,
			n = t.sZeroRecords;
		!t.sEmptyTable && n && "No records found." === e.sEmptyTable && Rt(t, t, "sZeroRecords", "sEmptyTable"), !t.sLoadingRecords && n && "Loading..." === e.sLoadingRecords && Rt(t, t, "sZeroRecords", "sLoadingRecords"), t.sInfoThousands && (t.sThousands = t.sInfoThousands), (t = t.sDecimal) && Et(t);
	}
	function l(t) {
		if (
			(ue(t, "ordering", "bSort"),
	...
	function d(e, n, r) {
		...
		(n._bAttrSrc = t.isPlainObject(c) && (r(c.sort) || r(c.type) || r(c.filter))),
			...
			n.bSortable && (e || r) ? (e && !r ? ((n.sSortingClass = i.sSortableAsc), (n.sSortingClassJUI = i.sSortJUIAscAllowed)) : !e && r ? ((n.sSortingClass = i.sSortableDesc), (n.sSortingClassJUI = i.sSortJUIDescAllowed)) : ((n.sSortingClass = i.sSortable), (n.sSortingClassJUI = i.sSortJUI))) : ((n.sSortingClass = i.sSortableNone), (n.sSortingClassJUI = ""));
	}
	function h(t) {
	...
	function lt(e) {
		for (var n = e.oClasses, a = e.sTableId, r = e.aLengthMenu, o = (i = t.isArray(r[0])) ? r[0] : r, i = ((r = i ? r[1] : r), t("<select/>", { name: a + "_length", "aria-controls": a, class: n.sLengthSelect })), l = 0, s = o.length; l < s; l++) i[0][l] = new Option("number" == typeof r[l] ? e.fnFormatNumber(r[l]) : r[l], o[l]);
		...
		(r = m.scrollHeight > m.clientHeight),
			e.scrollBarVis !== r && e.scrollBarVis !== a
				...
				: ((e.scrollBarVis = r),
				  ...
				  (d = T.outerWidth()),
				  "" === s ? ((x.width = "100%"), F && (T.find("tbody").height() > m.offsetHeight || "scroll" == v.css("overflow-y")) && (x.width = vt(T.outerWidth() - f)), (d = T.outerWidth())) : "" !== u && ((x.width = vt(u)), (d = T.outerWidth())),
				  pt(N, r),
				  pt(function (e) {
				  ...
				  T.outerWidth() < d ? ((n = m.scrollHeight > m.offsetHeight || "scroll" == v.css("overflow-y") ? d + f : d), F && (m.scrollHeight > m.offsetHeight || "scroll" == v.css("overflow-y")) && (x.width = vt(n - f)), ("" === s || "" !== u) && Lt(e, 1, "Possible column misalignment", 6)) : (n = "100%"),
				  (D.width = vt(n)),
				  (g.width = vt(n)),
		...
		t.extend(Vt.prototype, {
			...
			iterator: function (t, e, n, r) {
				...
				for ("string" == typeof t && ((r = n), (n = e), (e = t), (t = !1)), i = 0, l = h.length; i < l; i++) {
					...
					else if ("column" === e || "column-rows" === e || "row" === e || "cell" === e) for (f = this[i], "column-rows" === e && (c = Ce(h[i], p.opts)), s = 0, u = f.length; s < u; s++) (o = f[s]), (o = "cell" === e ? n.call(g, h[i], o.row, o.column, i, s) : n.call(g, h[i], o, i, s, c)), o !== a && d.push(o);
				}
	...
	Xt("columns()", function (e, n) {
		...
		(qt.defaults = {
			...
			oLanguage: {
				...
				sEmptyTable: `<div class="text-center p-3"><i class="fa fa-exclamation-circle fa-2x text-danger mb-2"></i><br><span class="text-muted">No record(s) found.</span></div>`,
				...
				sSearchPlaceholder: "",
				sUrl: "",
				sZeroRecords: `<div class="text-center p-3"><i class="fa fa-search fa-2x text-danger mb-2"></i><br><span class="text-muted">No matching record(s) found.</span></div>`
			},
		...
		r(qt.defaults),
		(qt.defaults.column = { aDataSort: null, iDataSort: -1, asSorting: ["asc", "desc"], bSearchable: !0, bSortable: !0, bVisible: !0, fnCreatedCell: null, mData: null, mRender: null, sCellType: "td", sClass: "", sContentPadding: "", sDefaultContent: null, sName: "", sSortDataType: "std", sTitle: null, sType: null, sWidth: null }),
		...
		(qt.ext = Ut = { buttons: {}, classes: {}, build: "bs4/dt-1.10.16", errMode: "alert", feature: [], search: [], selector: { cell: [], column: [], row: [] }, internal: {}, legacy: { ajax: null }, pager: {}, renderer: { pageButton: {}, header: {} }, order: {}, type: { detect: [], search: {}, order: {} }, _unique: 0, fnVersionCheck: qt.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: qt.version }),
...
!(function (e) {
	...
	return (
		...
		e.extend(o.ext.classes, { sWrapper: "dataTables_wrapper container-fluid dt-bootstrap4", sFilterInput: "form-control form-control-sm", sLengthSelect: "form-control form-control-sm", sProcessing: "dataTables_processing card", sPageButton: "paginate_button page-item" }),
